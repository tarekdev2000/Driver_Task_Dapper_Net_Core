    ...
    public static class DependencyInjection
    {
        ...
        public static IServiceCollection AddSwaggerOptions(this IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Version = "v1",
                    Title = "DriverTask.WebUI",
                    Description = "This is a test task",
                    Contact = new OpenApiContact
                    {
                        Name = "Tarek",
                        Email = "tarekdv2000@Gmail.com",
                        Url = new Uri("https://github.com/tarekdev2000"),
                    },
                });
        ...
        public static IApplicationBuilder UseAppSwagger(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "DriverTask.WebUI v1");
                options.SwaggerEndpoint("/swagger/v2/swagger.json", "DriverTask.WebUI v2");
